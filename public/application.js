...
// this is where auth tokens will live?
...
var clickCount = 0;
var gameClick = function gameClick(event) {
...
var signUpSubmit = function signUpSubmit(event) {
  ...
  gameApi.signUp(data).then(gameUi.signUpSuccess).catch(gameUi.signUpError);
  // $(event.target).toggle()
...
var signInSubmit = function signInSubmit(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  gameApi.signIn(data).then(gameUi.signInSuccess).catch(gameUi.signInError);
  // $(event.target).toggle()
  // $('#sign-up').toggle()
  $(event.target).trigger('reset');
  // $('#sign-out').show()
...
var changePasswordSubmit = function changePasswordSubmit(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  gameApi.changePassword(data).then(gameUi.changePasswordSuccess).catch(gameUi.changePasswordError);
  $(event.target).trigger('reset');
};

var signOutSubmit = function signOutSubmit(event) {
  event.preventDefault();
  gameApi.signOut().then(gameUi.signOutSuccess).catch(gameUi.signOutFail);
  // $('#sign-up').toggle()
  // $('#sign-in').toggle()
};

var getGamesSubmit = function getGamesSubmit(event) {
  event.preventDefault();
  // console.log('get games clicked')
  gameApi.getGames().then(gameUi.getGamesSuccess).catch(gameUi.getGamesFail);
};

var createGamesSubmit = function createGamesSubmit(event) {
  event.preventDefault();
  $('.box').on('click');

  // const gameBoard = []
  // console.log('create games clicked')
  gameApi.createGames().then(gameUi.createGamesSuccess).catch(gameUi.createGamesFail);
};

var updateGamesSubmit = function updateGamesSubmit(data) {
  event.preventDefault();
  gameApi.updateGames(data).then(gameUi.updateGamesSuccess).catch(gameUi.updateGamesFail);
};
...
var updateGames = function updateGames() {
...
var getGamesFail = function getGamesFail(error) {
  // console.log('failed to get games per ', error)
  $('#content').html('Failed to get games', error);
};

var createGamesSuccess = function createGamesSuccess(data) {
...
var createGamesFail = function createGamesFail(error) {
...
var updateGamesFail = function updateGamesFail(error) {
